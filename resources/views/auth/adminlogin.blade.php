          ...
          <div class="card">
            <div class="card-header" style="background: #0C1741;">
              <div class="app-brand text-center py-3" style="background: #0C1741;">
                  <h4 class="brand-name">Registre administrateur</h4>
              </div>
            </div>
            <div class="card-body p-5">

              <form  action="{{ route('adminLoginForm') }}"method="POST" enctype="multipart/form-data" id="form1">
                @csrf
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <label for="">Nom *</label>
                  <input type="name" class="form-control"  name="name" id="name"   autofocus>
                  <p id="p1" class="text-danger"></p>
                  </div>

                  <div class="form-group col-md-6 mb-4">
                  <label for="">E-mail *</label>
                  <input type="gmail" class="form-control" id="email" name="email"   autofocus>
                  @error('email')
                  ...
                  <input type="email" class="form-control" id="email_verification" name="email_verification"  autofocus>
                  ...
                  <input type="password" class="form-control" id="confirmPassword" name="confirmPassword"   autofocus>
                  ...
                  <input type="file" class="form-control"   name="image"  autocomplete="name" autofocus>
                  </div>
                  
                  <div class="col-md-6">
                  <label for="">Rôle </label>
                    <select name="role" id="" class=" form-control">
                      <option value="1">Administratrice</option>
                    </select>
                  </div>


                  <div class="col-md-12">
                    <button type="submit" id="submit" class="btn btn-lg  btn-block next-step " id="register">S'inscrire</button>
                  </div>
                </div>
              </form>
