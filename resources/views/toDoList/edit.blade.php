...
<div class="row">
    <div class="col-12 text-center">
        <div class="dashboard_image">
            <h1 class="brand_device mt-5"> Modifier la tâche</h1> 
        </div>
    </div>
    ...
    <div class="col-lg-12 mt-3">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{url('/update/task/'.$task->id)}}" method="POST" id="form" enctype="multipart/form-data">
                @csrf
                <table class="table text-dark table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="descrip" id="descrip" value="{{$task->descrip}}" class="form-control">
