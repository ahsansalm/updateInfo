...
<div class="row">
    <div class="col-12 text-center">
        <div class="dashboard_image">
            <h1 class="brand_device mt-5"> Liste des tâches préférées</h1> 
        </div>
    </div>
        ...
        columnDefs:[
            {
                ...
                render: function(data,type,full,meta){
                    return '<a class="btn btn-sm btn-success fa fa-check" style="font-size:18px" href="/task/edit/'+full.id+'"></a> <a class="btn btn-sm btn-danger fa fa-close" style="font-size:18px;"href="/task/incom/'+full.id+'"></a> '
                },
